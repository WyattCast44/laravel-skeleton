...
class ForgotPasswordTest extends TestCase
{
    ...
    public function test_unauthenticated_users_can_visit_forgot_password_page()
    {
        $this->get(route('password.email'))->assertOk();
    }

    public function test_authenticated_users_cannot_visit_page()
    {
        $this->login();
